...
class MainActivity : AppCompatActivity() {
    ...
    private fun getResult(output: FloatArray): String {
        ...
        return when {
            confidence < 93 -> "Invalid Image: This image does not appear to be a valid lung scan."
            confidence in 93.0..96.0 -> {
    ...
    private fun getResultDescription(output: FloatArray): String {
        ...
        return when {
            confidence < 93 -> "Please upload a proper lung scan image for accurate results."
            confidence in 93.0..96.0 -> {
                ...
                "$baseDescription However, the confidence is between 93% and 96%, indicating some uncertainty. Please consult a specialist doctor for confirmation."
            }
